...
public class TickerInfoSD implements Serializable {
    ...
    @PrimaryKey
    private TickerInfoSDPrimaryKey tickerInfoDataKey; 
     ...
     *
     * @return
     *       current value of 'tickerInfoDataKey'
     */
     ...
     * @param tickerInfoDataKey
     * 		new value for 'tickerInfoDataKey '
     */
