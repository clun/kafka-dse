...
public class StockTicksProducer implements Processor {
    ...
    public void init() {
        ...
        initialStockPrices = alphaVantageDao.getCurrentStockTicks(symbols)
    ...
    public void process(Exchange exchange) throws Exception {
        LOGGER.info("Pushing '{}' stocks ticks to Kafka topic '{}'", initialStockPrices.size(), topicTicks);
