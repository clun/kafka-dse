...
public class ProducerRoutes extends RouteBuilder {
    ...
    @Autowired
    private StockTicksProducer stockTickProducerAvro;
   
    @Autowired
    private StockTicksConsumer stockTickConsumerAvro;
    ...
    public void configure() throws Exception {
        ...
        from("timer:ticksConsumer?"
                + "fixedRate=true"
                + "&period={{alphavantage.pollingPeriod.ticks}}")
